...
void Registrasi(struct MasterAccount ** head) {
    ...
    do {
        temp_email = (unsigned char * ) malloc((EMAIL_MAX + PASSWORD_MAX) * sizeof(unsigned char));
        temp_password = (unsigned char * ) malloc(PASSWORD_MAX * sizeof(unsigned char));
        temp_username = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
...
void Add_Slave(struct SlaveAccount ** head_slave,
    ...
    do {
        temp_website = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
        temp_email = (unsigned char * ) malloc(EMAIL_MAX * sizeof(unsigned char));
        temp_password = (unsigned char * ) malloc(PASSWORD_MAX * sizeof(unsigned char));
        ...
        switch (yakin) {
        case 1:
            ptr = (struct SlaveAccount * ) malloc(sizeof(struct SlaveAccount));
...
bool Cari_Slave(struct SlaveAccount * head_slave,
    const unsigned char * password) {
    if (head_slave == NULL) {
        printf("=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=\n");
    ...
    do {
        pencarian = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
        decrypted_website = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
        decrypted_email = (unsigned char * ) malloc(EMAIL_MAX * sizeof(unsigned char));
        decrypted_password = (unsigned char * ) malloc(PASSWORD_MAX * sizeof(unsigned char));
        printf("=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=\n");
...
bool Delete_Slave(struct SlaveAccount ** head_slave,
    const unsigned char * password) {
    if (head_slave == NULL) {
        printf("=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=\n");
        printf("\nTidak ada akun. Silakan tambahkan akun terlebih dahulu!\n");
...
bool Show_All_Slave(struct SlaveAccount * head_slave,
    const unsigned char * password) {
    if (head_slave == NULL) {
        printf("=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=\n");
    ...
    struct SlaveAccount * ptr = NULL;
    unsigned char * decrypted_website = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
    unsigned char * decrypted_email = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
    unsigned char * decrypted_password = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
...
bool Login_Success(struct MasterAccount * head, unsigned char * password) {
    unsigned char * decrypted_username = (unsigned char * ) malloc(USERNAME_MAX * sizeof(unsigned char));
    ...
    do {
        ...
        switch (pilihan) {
        case 1:
            Show_All_Slave(head -> slave, password);
            break;
        case 2:
            Add_Slave( & head -> slave, password);
            break;
        case 3:
            Cari_Slave(head -> slave, password);
            break;
        case 4:
            Delete_Slave( & head -> slave, password);
            break;
        case 5:
            deleted = Delete_Account(head -> slave);
            head -> slave = NULL;
            break;
        case 6:
            break;
...
bool Login(struct MasterAccount ** head) { //function untuk mengecek login
    ...
    do {
        temp_email = (unsigned char * ) malloc(355 * sizeof(unsigned char));
        temp_password = (unsigned char * ) malloc(101 * sizeof(unsigned char));
        temp_md5 = (unsigned char * ) malloc(16 * sizeof(unsigned char));
